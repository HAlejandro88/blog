    ...
    return (
        <div className="grid grid-cols-2 gap-2">
            ...
            <div className="col-span-1 flex items-center justify-center">
                <img src="https://asset.swarovski.com/images/$size_1450/t_swa103/b_rgb:ffffff,c_scale,dpr_3.0,f_auto,w_500/5492687_png/dc-batman-swarovski-5492687.png" alt="Descripción de la imagen" className="w-1/3"/>
